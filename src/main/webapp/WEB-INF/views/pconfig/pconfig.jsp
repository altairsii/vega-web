	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="home.html">小财神环境信息管理</a>
			</div>
			<!-- /.navbar-header -->
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li><a href="home.html"><i class="fa fa-dashboard fa-fw"></i>
								环境信息管理</a></li>
						<li><a href="pconfig.html"><i
								class="fa fa-dashboard fa-fw"></i> 配置信息管理</a></li>
					</ul>
				</div>
				<!-- /.sidebar-collapse -->
			</div>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">${serverinfo }</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
